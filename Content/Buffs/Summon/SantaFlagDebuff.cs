...
{
	public class SantaFlagDebuff : ModBuff
	{
	...
	public class SantaFlagDebuffNPC : GlobalNPC
	{
		public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers) {
			...
			if (npc.HasBuff<SantaFlagDebuff>()) {
				// Apply a flat bonus to every hit
				modifiers.FlatBonusDamage += SantaFlagDebuff.TagDamage * projTagMultiplier;
			}
		}
	}
}