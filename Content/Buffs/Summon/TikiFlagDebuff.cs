...
{
	public class TikiFlagDebuff : ModBuff
	{
	...
	public class TikiFlagDebuffNPC : GlobalNPC
	{
		public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers) {
			...
			if (npc.HasBuff<TikiFlagDebuff>()) {
				// Apply a flat bonus to every hit
				modifiers.FlatBonusDamage += TikiFlagDebuff.TagDamage * projTagMultiplier;
			}
		}
	}
}