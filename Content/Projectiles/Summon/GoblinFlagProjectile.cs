...
{
    public class GoblinFlagProjectile : FlagProjectile
    {
        protected override string FLAG_CLOTH_TEXTURE_PATH => ModGlobal.MOD_TEXTURE_PATH + "Projectiles/GoblinFlag";
        protected override int FLAG_WIDTH => 80;
        protected override int FLAG_HEIGHT => 48;
