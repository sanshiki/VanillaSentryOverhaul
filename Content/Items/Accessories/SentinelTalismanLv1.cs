...
{
    public class SentinelTalismanLv1 : ModItem
    {
        public override string Texture => ModGlobal.MOD_TEXTURE_PATH + "Items/SentinelTalismanLv1";
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            // }
            player.GetModPlayer<SentinelTalismanLv1Player>().hasAccessory = true;
        }
    }

    public class SentinelTalismanLv1Player : ModPlayer
    {
        ...
        public override void PostUpdate()
        {
            ...
            if (hasAccessory && Player.maxTurrets >= 3) {
                ...
                int bonusDefense = MinionAIHelper.DefenseCompensate(armorDefense, 40, 0.5f, 20f, 4f);
