...
{
    public class AntlionSentryStaff : ModItem
    {
        public override string Texture => ModGlobal.MOD_TEXTURE_PATH + "Items/AntlionSentryStaff";
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<AntlionSentry>(); // This item creates the minion projectile
