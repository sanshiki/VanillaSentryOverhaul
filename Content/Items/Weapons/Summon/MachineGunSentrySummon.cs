...
{
    public class MachineGunSentrySummon : ModItem
    {

        private const float THROW_SPEED =10f;

        public override string Texture => ModGlobal.MOD_TEXTURE_PATH + "Items/MachineGunSentrySummonV2";
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                summonBall.SetSummonTarget(ModProjectileID.MachineGunSentry);
            }
