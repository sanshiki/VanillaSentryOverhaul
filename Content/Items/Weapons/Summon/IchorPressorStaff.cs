...
{
    public class IchorPressorStaff : ModItem
    {
        public override string Texture => ModGlobal.MOD_TEXTURE_PATH + "Items/IchorPressorSentryStaff";
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<IchorPressorSentry>(); // This item creates the minion projectile
